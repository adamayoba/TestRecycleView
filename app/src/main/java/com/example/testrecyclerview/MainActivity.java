...
public class MainActivity extends AppCompatActivity implements DetecteurDeClicSurRecycler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayoutManager = mLayoutManager=new GridLayoutManager(this,2, GridLayoutManager.VERTICAL, false);
    ...
    private ArrayList<Donnee> getDataSource() {
        ...
        for (int index = 0; index < 20; index++) {
            ...
            Donnee obj = new Donnee("Texte principal " + index,"Texte auxiliaire " + index,+ index);
